...
function page(s){
  ...
  <form action="ServletSearchCondition" method="post" id="frm">
    <div class="div_list">
		姓    名：<input type="text" class="form-control form1"   name="name" value="${score.getCourseName() }" />&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="table panel-body" id="tableClass">
			...
			<tr>
				<td>${list.getName() }</td>
				<td><a href="ServletFindCondition?name=${list.getName()}">查看详情</a><%--到时候更换路径到另一个详情页面--%>
			</tr>
			</c:forEach>
			<tr>
					<td colspan="7">
