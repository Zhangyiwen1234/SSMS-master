		...
		<div class="aside">
			...
			<ul class="nav">
				...
				<a href="#menu-stu" data-toggle="collapse">
					<i class="fa fa-group"></i>添加信息<i class="fa fa-angle-right"></i>
				</a>
				<ul id="menu-stu" class="collapse">
					<li><a href="SelectTeacherAllScore" target="mainRight">干部廉政信息</a></li>
					<li><a href="admin/addScore.jsp" target="mainRight">添加干部廉政信息</a></li>
				</ul>
			</li>
				<li>
					<a  href="#menu-info" data-toggle="collapse">
						<i class="fa fa-thumb-tack"></i>个人查看<i class="fa fa-angle-right"></i>
					</a>
                ...
                <%--<li                 <a href="#menu-class" data-toggle="collapse">
                        <iclass="fa fa-cogs"></i>课程管理<i class="fa fa-angle-right"></i>
                    </a>
