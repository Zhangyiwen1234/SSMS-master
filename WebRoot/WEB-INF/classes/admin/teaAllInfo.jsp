        ...
        <div class=" panel panel-default">
            ...
            <table class="table panel-body" id="tableClass">
                ...
                <c:forEach var="list" items="${list.pbjs }">
                    <tr>
                        <td><a href="ServletSearchCredict1?stu_name=${list.getStuName() }">廉政证明</a><%--最后链接到廉政证明中去--%>
                        ...
                        <td>${list.getMajor() }</td>
                        <td><a href="ServletSelectScore?scoreID=${list.getScoreID() }">修改</a>
                        <td><a href="ServletFindOneInformation?major=${list.getMajor() }">查看详情</a><%--到时候更换路径到另一个详情页面--%>
