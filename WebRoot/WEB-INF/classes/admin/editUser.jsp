	...
	<div class="div_ads">
		...
		<c:forEach var="list" items="${list}">
			<table>
				<tr>
					<td>序   号：</td>
					<td><input type="text" name="userid" class="form-control" value="${list.getUserID() }" required /></td>
				</tr>
				<tr>
					<td>账   号：</td>
					<td><input type="text" name="userNum" class="form-control" value="${list.getUserNum() }"  /></td>
				</tr>
				<tr>
					<td>姓&nbsp;&nbsp;&nbsp;名：</td>
				...
				<tr>
					<td>密&nbsp;&nbsp;&nbsp;码：</td>
					<td><input type="password"  name="password" class="form-control" value="${list.getPassword() }" /></td>
			...
			<%--	<tr>
					<td>身份：</td>
					<td><input type="text" name="roleName" class="form-control" value="${list.getRoleName() }" /></td>
				</tr>--%>
