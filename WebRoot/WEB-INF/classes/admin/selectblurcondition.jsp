...
<head>
	...
	<title>My JSP 'selectblurcondition.jsp' starting page</title>
...
<form action="ServletSearchCondition" method="post" id="frm">
	<div class="div_list">


		姓   名：<input type="text"  class="form1 form-control" name="stuName" value="${score.getName() }" /><br/><br/>
			...
			<table class="table panel-body" id="tableClass">
				...
				<c:forEach var="list" items="${list.pbjs }">
					<tr>
						...
						<td>${list.getName() }</td>
						<td><a href="ServletFindCondition?name=${list.getName()}">查看详情</a>
